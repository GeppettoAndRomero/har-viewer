...
const PRECACHE_URLS = [
  '/har-viewer/',
  '/har-viewer/manifest.json',
  '/har-viewer/icon-192.png',
  '/har-viewer/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/har-viewer/manifest.json';
}
