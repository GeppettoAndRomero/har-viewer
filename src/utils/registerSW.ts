...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/har-viewer/sw.js, scope=/har-viewer/）。
    // scope がツールの全 locale ページ（/har-viewer/, /har-viewer/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/har-viewer/sw.js', {
      scope: '/har-viewer/',
    });
